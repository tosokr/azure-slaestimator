...
export class MainPanel extends Component {
    ...
    constructor(props) {
        ...
        const downTimeYear = this.calculateDownTimeYear(slaTotal)
        const downTimeMultiRegion = this.calculateDownTime(slaTotalMultiRegion)
        const downTimeMultiRegionYear = this.calculateDownTimeYear(slaTotalMultiRegion)
        ...
        this.state = {
            ...
            downTime: downTime,
            downTimeYear: downTimeYear,
            downTimeMultiRegion: downTimeMultiRegion,
            downTimeMultiRegionYear: downTimeMultiRegionYear,
    ...
    calculateSlaMultiRegion(slaEstimation, tiers) {
        ...
        return Math.round(((total * 100) + Number.EPSILON) * 1000000) / 1000000;
    }
    ...
    calculateDownTime(sla) {
        if (sla == 0)
            return 0;
        // 365/12 = 30.41666666666667 days per month
        // 0.41666666666667 * 24 = 10 hours
        // 30*24*60 + 10*60 = 43200 + 600 = 43800 minutes per month
        return Math.round((43800 * (1 - (sla / 100)) + Number.EPSILON) * 100000) / 100000;
    }

    calculateDownTimeYear(sla) {
        if (sla == 0)
            return 0;

        //365*4 + 1 = 1461 days in 4 years
        //1461/4 = 365.25 days in average
        //365*24*60 + 0.25*24*60 =  525600 + 360 = 525960
        return Math.round((525960 * (1 - (sla / 100)) + Number.EPSILON) * 100000) / 100000;
    }
            ...
            <div className="main-panel">
                <div className="top-panel">
                    <div className="top-title">
                        <h1 className="top-title-inner">Azure Composite SLA Estimator</h1>
